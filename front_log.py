...
UPLOADS_PATH = join(dirname(realpath(__file__)), 'users.json')
...
def hello_world():
    if oidc.user_loggedin:
        ...
        return 'You are not connected, <a href="/private">Log in</a>'
...
def hello_me():
    ...
    if user_id in oidc.credentials_store:
        try:
            ...
            greeting = "%s 's Anime Top" % username


    return ("""%s your email is %s and your user_id is %s!
               <ul>
                 <li><a href="/">Your Anime Top</a></li>
